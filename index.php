...
.overlay{position: relative;width: 100%;height: 100%;background-color: rgba(0,0,0,0.8);display: block;}
    ...
    .herotxt{padding: 0;}
    .swrap{font-size: 5.3em;font-weight: bold;animation: sld 15s ease-in-out infinite;}
    .swrap a {color: #fff;text-decoration: none;}
    /*.stxt1{padding: 10px 20px;animation: slideIn .5s, pulse 1s .5s;position: relative;transform-origin: left center;}
    .stxt2, .stxt3, .stxt4{padding: 10px 20px;}
    .stxt2{animation: slideIn 1.5s, pulse 1s 1.5s;position: relative;transform-origin: left center;}
    .stxt3{animation: slideIn 3s, pulse 1s 3s;position: relative;transform-origin: left center;}
    .stxt4{animation: slideIn 4.5s, pulse 1s 4.5s;position: relative;transform-origin: left center;}*/
    .stxt1,.stxt2,.stxt3,.stxt4,.stxt5{display: inline-block;width: 100%;position: absolute;padding: 10px 20px;}
    .stxt1{animation: pulse 1s .3s;transform-origin: left center;}
    .stxt2{margin-left: 100%;animation: pulse 1s 3.7s;transform-origin: left center;}
    .stxt3{margin-left: 200%;animation: pulse 1s 7.4s;transform-origin: left center;}
    .stxt4{margin-left: 300%;animation: pulse 1s 11.1s;transform-origin: left center;}
    .stxt5{margin-left: 400%;}
    ...
    .dropcon{display: none;position: absolute;box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);background-color: #F7F7F7;top: 74px;left: 0;padding: 8px 5px;width: 100%;}
    .dropcon a{display: block;padding: 15px;}
...
h1{color: #015A2E;}
.pnts {width: 70%;padding:10px 25px;background-color: #ddd;}
    .pnts ul{list-style-type: none;padding: 0;margin: 0;}
    .pnts li{background: url('bullet4.png') no-repeat left top;min-height: 54px;padding-left: 38px;padding-top: 0px;padding-bottom: 5px;font-size: 19.2px;color: #777;}
    .res{width: 30%;padding: 134px 10px;background-color: #FE0000;color: #fff;}
    #res{padding-top: 150px;}
    .prmhdsm{width: 100%;display: none;}
    .prmhd{width: 30%;}
    .prmtxt{width: 70%;padding:10px 25px;background-color: #eee;}
    @media only screen and (max-width: 600px){
        ...
        .pnts li{padding-left: 38px;padding-top: 0px;padding-bottom: 5px;}
            .pnts {width: 100%;padding:10px ;}
            .res{width: 100%}
            .prmhdsm{display: contents;}
    .prmhd{display: none;}
    .prmtxt{width: 100%;}
...
<body>
    <div class="nav" style="box-shadow: 0px 5px 5px rgba(0,0,0,0.6);background-color: #F7F7F7;">    
        ...
        <div class="lnk">
        <a href="" class="lrghd">Home</a>
        <a href="#about" class="lrghd">About</a>
        <a href="services.php" class="lrghd">Services</a>
        ...
        <div class="overlay">
            <div class="herotxt">
                <div class="htxt">
                    <div class="swrap">
                        <a href="services.php">
                        <div class="stxt1">Do you have a <i>property</i> in Assam?</div>
                        <div class="stxt2">Are you staying away from your <i>property</i>?</div>
                        <div class="stxt3">Having problems renting out your <i>property</i>?</div>
                        <div class="stxt4">Do you travel frequently to manage your <i>property</i>?</div>
                        <div class="stxt5">Do you have a <i>property</i> in Assam?</div></a>
                    </div>
                </div>
            </div>
            <a href="#res"><div class="scroll-downs">
            ...
            <!--<div class="gobot">
                <p class="l1">If <i>YES?</i></p><p class="l2">Our services can help you extensively</p>
            </div>-->
        </div>
    </div>
    <div class="contain" id="res">
        <div class="row">
            <div class="col res" style="">
                <center><h1 style="color: #fff;">7 Reasons to<br>choose us</h1></center>
            </div>
            <div class="col pnts" style="">
                <ul>
                    <li>We deposit rent in your account every month right on time.</li>
                    <li>We have the best customer service that is capable of handling all customer queries.</li>
                    <li>We have an extremely transparent work process so rest assured you would know what you are dealing with in each part of the process.</li>
                    <li>We do a thorough background check on each tenant to ensure safety of the property.</li>
                    <li>We give complete control over your property from deciding rent to tenant profile approval.</li>
                    <li>You pay us only when you start receiving your rents and there are no other hidden charges.</li>
                    <li>We ensure the quality of your property is maintained by providing half yearly maintenance check and also at the time of onboarding new tenant and exiting old tenants.</li>
                </ul>
            </div>
        </div>
    </div>
    <div class="contain row" id="about">
        <div class=" col abt2">
            <img src="aboutus.jpg" style="height: 400px"; alt="about">
        </div>
        <div class="col abt">
            <h1>About Us</h1>
            <p>A newly established company located in Guwahati - the heart of Assam and the gateway to the North East of India. Zayne is started by a highly qualified and experienced professional from the service and payment industry with a goal to simplify and ease property ownership and management thereby helping home owners living away to maximize returns through safe and secure processes.</p>
        </div>
    </div>
    ...
    <div class="contain">
        <img src="new8.jpg" style="width: 100%;"  alt="flochart">
    </div>
    <div class="contain"  style="" >
        <div class="prom">
            <div class="row">
                <div class="col prmhdsm" style="">
                    <center><h1>We Promise</h1></center>
                 </div>
                 <div class="col prmtxt" style="">
                    <p>Complete transparency and honesty is what we provide.</p>
                    <p>To cater to the entire population of home owners living away.</p>
                 </div>
                 <div class="col prmhd" style="">
                    <center><h1>We Promise</h1></center>
                 </div>
            </div>
        </div>
    ...
    <div class="tmcon" style="">
        <div class="contain team row"> 
            <div class="teamimg2 col">
                <img src="SIMANTA%20-%20Simanta%20Baishya.jpg" style="" alt="founder" class="founimg">
            </div>       
            <div class="teamtxt col">
                <h1>Our Team</h1>
                <p><b>Founder</b></p>
                <hr style="">
                <p>Simanta Baishya, born and brought up in Tezpur and Guwahati, Assam is a post graduate from Edinburgh Business School and has about 22 years of experience in the Banking, Insurance and Payments Industry with companies like GE, Citibank, Pinelabs. Simanta is an innovative, dynamic and a result oriented professional with great organisational and strategic skills.</p>
            </div>
            <div class="teamimg col">
                <img src="SIMANTA%20-%20Simanta%20Baishya.jpg" style="" alt="founder" class="founimg">
            </div>
        </div>
    </div>
